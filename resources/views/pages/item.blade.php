  ...
  <section id="item">
    <div class="added-to-basket">
      <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1 9L4.23309 11.4248C4.66178 11.7463 5.26772 11.6728 5.60705 11.2581L14 1" stroke="white" stroke-width="1.3" stroke-linecap="round"/>
      </svg>
      Товар добавлен в корзину
    </div>
{{--    mobile title , goBack link and share svg--}}
    <div class="mobile-title">
      <div class="">
        <a href="#">
          <svg width="31" height="19" viewBox="0 0 31 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M30 9.35547L1 9.35547" stroke="#212123" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9.35547 1L0.999537 9.35593L9.35547 17.7119" stroke="#212123" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </a>
        Декор
      </div>
      <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16.4205 15C16.4205 13.6538 15.2962 12.5624 13.9092 12.5624C12.5222 12.5624 11.398 13.6538 11.398 15C11.398 16.3461 12.5222 17.4375 13.9092 17.4375C15.2962 17.4375 16.4205 16.3461 16.4205 15Z" fill="#505154"/>
        <path d="M13.9092 11.9999C12.2046 11.9999 10.8185 13.3455 10.8185 15C10.8185 16.6544 12.2046 18 13.9092 18C15.6139 18 17 16.6544 17 15C17 13.3455 15.6139 11.9999 13.9092 11.9999ZM13.9092 16.875C12.8437 16.875 11.9775 16.0334 11.9775 15C11.9775 13.9665 12.8437 13.1249 13.9092 13.1249C14.9748 13.1249 15.8409 13.9665 15.8409 15C15.8409 16.0334 14.9748 16.875 13.9092 16.875Z" fill="#505154"/>
        <path d="M16.4205 2.99998C16.4205 1.65387 15.2962 0.562505 13.9092 0.562505C12.5222 0.562505 11.398 1.65387 11.398 2.99998C11.398 4.34622 12.5222 5.43758 13.9092 5.43758C15.2962 5.43758 16.4205 4.34622 16.4205 2.99998Z" fill="#505154"/>
        <path d="M13.9092 0C12.2046 0 10.8185 1.34556 10.8185 2.99997C10.8185 4.65453 12.2046 6.00009 13.9092 6.00009C15.6139 6.00009 17 4.65453 17 2.99997C17 1.34556 15.6139 0 13.9092 0ZM13.9092 4.87508C12.8437 4.87508 11.9775 4.03352 11.9775 2.99997C11.9775 1.96657 12.8437 1.12501 13.9092 1.12501C14.9748 1.12501 15.8409 1.96657 15.8409 2.99997C15.8409 4.03352 14.9748 4.87508 13.9092 4.87508Z" fill="#505154"/>
        <path d="M5.60214 8.99984C5.60214 7.65359 4.47775 6.56237 3.09076 6.56237C1.70392 6.56237 0.579527 7.65359 0.579527 8.99984C0.579527 10.3461 1.70392 11.4373 3.09076 11.4373C4.47775 11.4373 5.60214 10.3461 5.60214 8.99984Z" fill="#505154"/>
        <path d="M3.09077 5.99986C1.38628 5.99986 0 7.34529 0 8.99984C0 10.6544 1.38628 11.9998 3.09077 11.9998C4.79539 11.9998 6.18167 10.6544 6.18167 8.99984C6.18167 7.34529 4.79539 5.99986 3.09077 5.99986ZM3.09077 10.8748C2.02523 10.8748 1.15905 10.0334 1.15905 8.99984C1.15905 7.96629 2.02523 7.12487 3.09077 7.12487C4.15644 7.12487 5.02262 7.96629 5.02262 8.99984C5.02262 10.0334 4.15644 10.8748 3.09077 10.8748Z" fill="#505154"/>
        <path d="M4.91404 9.35957C4.64507 9.35957 4.38389 9.49539 4.2417 9.73832C4.03074 10.0976 4.16063 10.5558 4.53075 10.7614L11.7006 14.7289C12.0707 14.9352 12.5428 14.8091 12.7546 14.4485C12.9656 14.0892 12.8357 13.6309 12.4656 13.4254L5.29563 9.45789C5.17508 9.39115 5.04378 9.35957 4.91404 9.35957Z" fill="#505154"/>
        <path d="M12.0842 3.17218C11.9544 3.17218 11.8231 3.20376 11.7025 3.27051L4.53255 7.23797C4.16243 7.44273 4.03268 7.901 4.24364 8.26108C4.45375 8.62102 4.92659 8.74778 5.29757 8.54151L12.4675 4.57404C12.8377 4.36928 12.9674 3.91101 12.7564 3.55093C12.6135 3.308 12.3524 3.17218 12.0842 3.17218Z" fill="#505154"/>
      </svg>
    </div>
{{--    mobile title , goBack link and share svg--}}
      ...
      <div class="wrapper">
        <a class='share' href="#">
          <svg viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.4205 15C16.4205 13.6538 15.2962 12.5624 13.9092 12.5624C12.5222 12.5624 11.398 13.6538 11.398 15C11.398 16.3461 12.5222 17.4375 13.9092 17.4375C15.2962 17.4375 16.4205 16.3461 16.4205 15Z" fill="#C6C4BD"/>
            <path d="M13.9092 11.9999C12.2046 11.9999 10.8185 13.3455 10.8185 15C10.8185 16.6544 12.2046 18 13.9092 18C15.6139 18 17 16.6544 17 15C17 13.3455 15.6139 11.9999 13.9092 11.9999ZM13.9092 16.875C12.8437 16.875 11.9775 16.0334 11.9775 15C11.9775 13.9665 12.8437 13.1249 13.9092 13.1249C14.9748 13.1249 15.8409 13.9665 15.8409 15C15.8409 16.0334 14.9748 16.875 13.9092 16.875Z" fill="#C6C4BD"/>
            <path d="M16.4205 2.99998C16.4205 1.65387 15.2962 0.562505 13.9092 0.562505C12.5222 0.562505 11.398 1.65387 11.398 2.99998C11.398 4.34622 12.5222 5.43758 13.9092 5.43758C15.2962 5.43758 16.4205 4.34622 16.4205 2.99998Z" fill="#C6C4BD"/>
            <path d="M13.9092 0C12.2046 0 10.8185 1.34556 10.8185 2.99997C10.8185 4.65453 12.2046 6.00009 13.9092 6.00009C15.6139 6.00009 17 4.65453 17 2.99997C17 1.34556 15.6139 0 13.9092 0ZM13.9092 4.87508C12.8437 4.87508 11.9775 4.03352 11.9775 2.99997C11.9775 1.96657 12.8437 1.12501 13.9092 1.12501C14.9748 1.12501 15.8409 1.96657 15.8409 2.99997C15.8409 4.03352 14.9748 4.87508 13.9092 4.87508Z" fill="#C6C4BD"/>
            <path d="M5.60214 8.99984C5.60214 7.65359 4.47775 6.56237 3.09076 6.56237C1.70392 6.56237 0.579527 7.65359 0.579527 8.99984C0.579527 10.3461 1.70392 11.4373 3.09076 11.4373C4.47775 11.4373 5.60214 10.3461 5.60214 8.99984Z" fill="#C6C4BD"/>
            <path d="M3.09077 5.99986C1.38628 5.99986 0 7.34529 0 8.99984C0 10.6544 1.38628 11.9998 3.09077 11.9998C4.79539 11.9998 6.18167 10.6544 6.18167 8.99984C6.18167 7.34529 4.79539 5.99986 3.09077 5.99986ZM3.09077 10.8748C2.02523 10.8748 1.15905 10.0334 1.15905 8.99984C1.15905 7.96629 2.02523 7.12487 3.09077 7.12487C4.15644 7.12487 5.02262 7.96629 5.02262 8.99984C5.02262 10.0334 4.15644 10.8748 3.09077 10.8748Z" fill="#C6C4BD"/>
            <path d="M4.91404 9.35957C4.64507 9.35957 4.38389 9.49539 4.2417 9.73832C4.03074 10.0976 4.16063 10.5558 4.53075 10.7614L11.7006 14.7289C12.0707 14.9352 12.5428 14.8091 12.7546 14.4485C12.9656 14.0892 12.8357 13.6309 12.4656 13.4254L5.29563 9.45789C5.17508 9.39115 5.04378 9.35957 4.91404 9.35957Z" fill="#C6C4BD"/>
            <path d="M12.0842 3.17218C11.9544 3.17218 11.8231 3.20376 11.7025 3.27051L4.53255 7.23797C4.16243 7.44273 4.03268 7.901 4.24364 8.26108C4.45375 8.62102 4.92659 8.74778 5.29757 8.54151L12.4675 4.57404C12.8377 4.36928 12.9674 3.91101 12.7564 3.55093C12.6135 3.308 12.3524 3.17218 12.0842 3.17218Z" fill="#C6C4BD"/>
          </svg>
        </a>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div id="img-container2">
                <div class="large-img"  data-remodal-target="Zoom-popup" style="background-image: url('/i/test.png')"></div>
              </div>
            </div>
            <div class="swiper-slide">
              <div id="img-container">
                <div class="large-img" data-remodal-target="Zoom-popup" style="background-image: url('/i/test2.png')"></div>
              </div>
            </div>
            <div class="swiper-slide">
              <div id="img-container">
...
{{--              mobile info --}}
        <div class="mobile-info">
          <p class="info-name">Статуэтка Күйші ару</p>
          <p class="info-price">4 350 ₸</p>
        </div>
{{--              mobile info --}}
      </div>
      <div class="offer">
        <div class="offer__description">
          ...
          <form method="POST" action="#">
            ...
            <div class="buttons">
              <div>
                <button data-remodal-target="Added-to-favorites" class="favorites">
                ...
                <button class="main-btn" data-remodal-target="Added-to-basket">Добавить в корзину</button>
              </div>
              <button class="primary-btn">Купить в рассрочку</button>
            </div>
          </form>
        </div>
        <a href="#" class="offer__delivery">
        ...
        <div class="swiper-item">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="single">
                <div class="single-image">
                  <img src={{ url("/i/item/single-1.png") }} alt=""/>
                </div>
            ...
            <div class="swiper-slide">
              <div class="single">
                <div class="single-image">
                  <img src={{ url("/i/item/single-2.png") }} alt=""/>
                </div>
                <p>Картина «Сакские предания»</p>
                <div class="single-breadcrumbs">
                  <a href="#">Полистоун</a>
            ...
            <div class="swiper-slide">
              <div class="single">
                <div class="single-image">
                  <img src={{ url("/i/item/single-3.png") }} alt=""/>
                </div>
                <p>Картина «Сакские предания»</p>
                <div class="single-breadcrumbs">
                  <a href="#">Полистоун</a>
            ...
            <div class="swiper-slide">
              <div class="single">
                <div class="single-image">
                  <img src={{ url("/i/item/single-4.png") }} alt=""/>
                </div>
                <p>Картина «Сакские предания»</p>
                <div class="single-breadcrumbs">
                  <a href="#">Полистоун</a>
...
{{--mobile similar swiper--}}
    <div class="similar-mobile">
      <h3 class="similar-title">Похожие товары</h3>
      @include('mobile-components.single_product_swiper')
    </div>
{{--mobile similar swiper--}}
