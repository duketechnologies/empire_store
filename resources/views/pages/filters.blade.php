...
{{--    mobile filter--}}
    <div class="type">
      <ul class="links">
        ...
        <li ><a href="#" data-filter="filter2">Посуда</a></li>
        <li ><a href="#" data-filter="filter3">Книги</a></li>
        <li ><a href="#" data-filter="filter4">Шахматы и нарды</a></li>
        <li ><a href="#" data-filter="filter5">Галантерея</a></li>
        <li ><a href="#" data-filter="filter6">Часы</a></li>
                ...
                <div class="grid">
                    ...
                    <div class="grid__blocks">
                        <a href="/item" class="content">
                            ...
                            <div class="grid-img" >
{{--                                data-static="another_image_src" data-hover="image_src"--}}
                                <img src={{ url("/i/test2.png") }} alt=""/>
                            </div>
                        </a>
                        <div class="info">
                            <p class="name">Лампа Айша биби</p>
                    ...
                    <div class="grid__blocks">
                        <a href="/item" class="content">
                            ...
                            <div class="grid-img">
                                <img src={{ url("/i/filters/filter-3.png") }} alt=""/>
                            </div>
                        </a>
                        <div class="info">
                            <p class="name">Лампа Айша биби</p>
                    ...
                    <div class="grid__blocks">
                        <a href="/item" class="content">
                            ...
                            <div class="grid-img">
                                <img src={{ url("/i/filters/filter-1.png") }} alt=""/>
                            </div>
                        </a>
                        <div class="info">
                            <p class="name">Лампа Айша биби</p>
                    ...
                    <div class="grid__blocks">
                        <a href="/item" class="content">
                            ...
                            <div class="grid-img">
                                <img src={{ url("/i/filters/filter-2.png") }} alt=""/>
                            </div>
                        </a>
                        <div class="info">
                            <p class="name">Лампа Айша биби</p>
                    ...
                    <div class="grid__blocks">
                        <a href="/item" class="content">
                            ...
                            <div class="grid-img">
                                <img src={{ url("/i/filters/filter-4.png") }} alt=""/>
                            </div>
                        </a>
                        <div class="info">
                            <p class="name">Лампа Айша биби</p>
                    ...
                    <div class="grid__blocks">
                        <a href="/item" class="content">
                            ...
                            <div class="grid-img">
                                <img src={{ url("/i/filters/filter-5.png") }} alt=""/>
                            </div>
                        </a>
                        <div class="info">
                            <p class="name">Лампа Айша биби</p>
                    ...
                    <div class="grid__blocks">
                        <a href="/item" class="content">
                            ...
                            <div class="grid-img">
                                <img src={{ url("/i/filters/filter-6.png") }} alt=""/>
                            </div>
                        </a>
                        <div class="info">
                            <p class="name">Лампа Айша биби</p>
                        ...
                        <div class="grid__blocks">
                            ...
                            <div class="info">
                                ...
                                @foreach($pricelist as $price)
                                    @if($price->product_id === $product->astrum_id)
                                        <p class="price">
                                            <!-- <span class="old">₸</span> -->
        ...
        <div class="grid">
          <div class="grid__blocks">
            <a href="/item" class="content">
              ...
              <div class="grid-img">
                <img src={{ url("/i/test.png") }}  onmouseover={{ url("i/filters/hover.png") }} onmouseout={{ url("/i/test.png") }} alt=""/>
              </div>
            </a>
            <div class="info">
              <p class="name">Лампа Айша биби</p>
          ...
          <div class="grid__blocks">
            <a href="/item" class="content">
              ...
              <div class="grid-img" >
                <img src={{ url("/i/test2.png") }} alt=""/>
                <img src={{ url("i/filters/hover.png") }} alt="" class="img-top"/>
              </div>
            </a>
            <div class="info">
              <p class="name">Лампа Айша биби</p>
              <p class="price">4 310 ₸</p>
            </div>
          </div>
          <div class="grid__blocks">
            <a href="/item" class="content">
